...
st.markdown("<h1 style='text-align: left; color: green;'>Segmentation of organs", unsafe_allow_html=True)
dataset=st.selectbox(' Select Data Class:',("LUNG","RETINA","BRAIN","LIVER"))
